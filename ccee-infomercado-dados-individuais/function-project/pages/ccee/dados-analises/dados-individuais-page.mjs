...
export default class CCEEDadosIndividuaisPage extends NavigableObject{
    ...
    #PARTIAL_NAME_SEARCHED_FILE  = 'InfoMercado - Dados Individuais';

    constructor(driver, context){
        super(driver, context);
    }

    async getUrlDownloadDadosIndividuais(){ 
        let url;
    ...
    async open(){
        await super.open(this.#URL_MERCADO_MENSAL);
    }
}