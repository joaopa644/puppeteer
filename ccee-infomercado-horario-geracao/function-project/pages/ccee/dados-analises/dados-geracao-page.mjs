...
export default class CCEEDadosGeracaoPage extends NavigableObject{
    #URL_CONSUMO = 'https://www.ccee.org.br/web/guest/dados-e-analises/dados-geracao';
    ...
    #PARTIAL_NAME_SEARCHED_FILE  = 'InfoMercado - Dados Horários de Geração';

    constructor(driver, context){
        super(driver, context);
    }

    async getUrlDownloadDadosAnalise(currentMonthYear){ 
        let url;

        this.context.log('Getting download link from the file:', this.#PARTIAL_NAME_SEARCHED_FILE);
        
        await this.typeText(this.#SELECT_DATE, currentMonthYear);
